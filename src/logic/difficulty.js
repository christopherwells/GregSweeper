...
export const PAR_MODEL = {
  // Last refit: 2026-08-16 | brms (5 users · max Rhat = 1.005, min ESS = 1255, divergent = 0/4000) | N=652 scores, 282 dates, 6 players | R²=0.568 (log scale)
  ...
  intercept: 2.9594,
  secPerCell: 0.00070,
  secPerMineFlag: 0.04817,
  secPerPatternMove: 0.03367,
  secPerSearchMove: 0.01101,
  secPerWallEdge: 0.00226,
  secPerZeroCluster: 0.00112,
  secPerMysteryCell: 0.00146,
  secPerLiarCell: 0.00135,
  secPerLockedCell: 0.04318,
  secPerWormholePair: 0.03589,
  secPerMirrorPair: 0.06103,
  secPerSonarCell: 0.06833,
  secPerCompassCell: 0.04690,
  secPerWormLoad: 0.00891,
};
// PAR_MODEL:END
...
export const PAR_MODEL_TIMED = {
  ...
  intercept: 2.6771,
  secPerCell: 0.00136,
  secPerMineFlag: 0.04768,
  secPerPatternMove: 0.05223,
  secPerSearchMove: 0.01810,
  secPerWallEdge: 0.00288,
  secPerZeroCluster: 0.00151,
  secPerMysteryCell: 0.00187,
  secPerLiarCell: 0.00170,
  secPerLockedCell: 0.05565,
  secPerWormholePair: 0.04655,
  secPerMirrorPair: 0.07819,
  secPerSonarCell: 0.08641,
  secPerCompassCell: 0.06058,
  secPerWormLoad: 0.01132,
};
// TIMED_PAR_MODEL:END
...
export const PAR_MODEL_SHAPES = {
  ...
  hex: {
    ...
    intercept: 2.7402,
    secPerCell: -0.00994,
    secPerMineFlag: 0.10061,
    secPerPatternMove: 0.03367,
    secPerSearchMove: 0.01101,
    secPerWallEdge: 0.00226,
    secPerZeroCluster: 0.01624,
    secPerMysteryCell: 0.00146,
    secPerLiarCell: 0.00135,
    secPerLockedCell: 0.04318,
    secPerWormholePair: 0.03589,
  ...
  cairo: {
    ...
    intercept: 2.6904,
    secPerCell: 0.01983,
    secPerMineFlag: 0.01973,
    secPerPatternMove: 0.03367,
    secPerSearchMove: 0.01101,
    secPerWallEdge: 0.00226,
    secPerZeroCluster: -0.04856,
    secPerMysteryCell: 0.00146,
    secPerLiarCell: 0.00135,
    secPerLockedCell: 0.04318,
    secPerWormholePair: 0.03589,
  ...
  rhombille: {
    ...
    intercept: 2.7698,
    secPerCell: 0.07427,
    secPerMineFlag: -0.22675,
    secPerPatternMove: 0.03367,
    secPerSearchMove: 0.01101,
    secPerWallEdge: 0.00226,
    secPerZeroCluster: 0.24974,
    secPerMysteryCell: 0.00146,
    secPerLiarCell: 0.00135,
    secPerLockedCell: 0.04318,
    secPerWormholePair: 0.03589,
