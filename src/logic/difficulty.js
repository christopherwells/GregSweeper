...
export const PAR_MODEL = {
  // Last refit: 2026-08-13 | brms (5 users · max Rhat = 1.003, min ESS = 908, divergent = 0/4000) | N=419 scores, 171 dates, 6 players | R²=0.468 (log scale)
  ...
  secPerLockedCell: 0.03429,
  secPerWormholePair: 0.02755,
  secPerMirrorPair: 0.03195,
  secPerSonarCell: 0.05701,
  secPerCompassCell: 0.02920,
  secPerWormLoad: 0.00951,
};
// PAR_MODEL:END
...
export const PAR_MODEL_TIMED = {
  // Last refit: 2026-08-13 | brms-timed (n=144)
  // scale:"log" => par = exp(intercept + Σ coef·feature): multiplicative,
  // lognormal MEDIAN. Coefficients are LOG-MULTIPLIERS per unit, NOT seconds.
  ...
  secPerPatternMove: 0.05015,
  secPerSearchMove: 0.01735,
  secPerWallEdge: 0.00245,
  secPerZeroCluster: 0.00145,
  secPerMysteryCell: 0.00175,
  secPerLiarCell: 0.00158,
  secPerLockedCell: 0.04371,
  secPerWormholePair: 0.03524,
  secPerMirrorPair: 0.04154,
  secPerSonarCell: 0.07262,
  secPerCompassCell: 0.03718,
  secPerWormLoad: 0.01215,
};
// TIMED_PAR_MODEL:END
