...
export const PAR_MODEL = {
  // Last refit: 2026-08-07 | brms (4 users · max Rhat = 1.005, min ESS = 1397, divergent = 0/4000) | N=399 scores, 165 dates, 6 players | R²=0.495 (log scale)
  ...
  intercept: 3.0062,
  secPerCell: 0.00054,
  secPerMineFlag: 0.04950,
  secPerPatternMove: 0.02145,
  secPerSearchMove: 0.01300,
  secPerWallEdge: 0.00192,
  secPerZeroCluster: 0.00108,
  secPerMysteryCell: 0.00139,
  secPerLiarCell: 0.00122,
  secPerLockedCell: 0.02910,
  secPerWormholePair: 0.00175,
  secPerMirrorPair: 0.02677,
  secPerSonarCell: 0.05472,
  secPerCompassCell: 0.02465,
  secPerWormLoad: 0.00680,
};
// PAR_MODEL:END
...
export const PAR_MODEL_TIMED = {
  // Last refit: 2026-08-07 | brms-timed (n=137)
  // scale:"log" => par = exp(intercept + Σ coef·feature): multiplicative,
  // lognormal MEDIAN. Coefficients are LOG-MULTIPLIERS per unit, NOT seconds.
  ...
  secPerPatternMove: 0.04939,
  secPerSearchMove: 0.01912,
  secPerWallEdge: 0.00247,
  secPerZeroCluster: 0.00142,
  secPerMysteryCell: 0.00175,
  secPerLiarCell: 0.00159,
  secPerLockedCell: 0.03711,
  secPerWormholePair: 0.00226,
  secPerMirrorPair: 0.03467,
  secPerSonarCell: 0.07092,
  secPerCompassCell: 0.03197,
...
export const PAR_MODEL_SHAPES = {
  // Last refit: 2026-08-07 | composed: PAR_MODEL base + per-shape deviations
