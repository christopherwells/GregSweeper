...
export const PAR_MODEL = {
  // Last refit: 2026-08-12 | brms (5 users · max Rhat = 1.005, min ESS = 1076, divergent = 0/4000) | N=415 scores, 170 dates, 6 players | R²=0.470 (log scale)
  ...
  intercept: 3.0054,
  secPerCell: 0.00053,
  secPerMineFlag: 0.04920,
  secPerPatternMove: 0.02193,
  secPerSearchMove: 0.01254,
  secPerWallEdge: 0.00188,
  secPerZeroCluster: 0.00111,
  secPerMysteryCell: 0.00141,
  secPerLiarCell: 0.00125,
  secPerLockedCell: 0.03301,
  secPerWormholePair: 0.02594,
  secPerMirrorPair: 0.02942,
  secPerSonarCell: 0.05609,
  secPerCompassCell: 0.02750,
  secPerWormLoad: 0.00861,
};
// PAR_MODEL:END
...
export const PAR_MODEL_TIMED = {
  // Last refit: 2026-08-12 | brms-timed (n=144)
  // scale:"log" => par = exp(intercept + Σ coef·feature): multiplicative,
  // lognormal MEDIAN. Coefficients are LOG-MULTIPLIERS per unit, NOT seconds.
  ...
  intercept: 2.6898,
  secPerCell: 0.00131,
  secPerMineFlag: 0.04772,
  secPerPatternMove: 0.05004,
  secPerSearchMove: 0.01748,
  secPerWallEdge: 0.00240,
  secPerZeroCluster: 0.00149,
  secPerMysteryCell: 0.00186,
  secPerLiarCell: 0.00158,
  secPerLockedCell: 0.04145,
  secPerWormholePair: 0.03271,
  secPerMirrorPair: 0.03695,
  secPerSonarCell: 0.07219,
  secPerCompassCell: 0.03580,
  secPerWormLoad: 0.01122,
};
// TIMED_PAR_MODEL:END
...
export const PAR_MODEL_SHAPES = {
  // Last refit: 2026-08-12 | composed: PAR_MODEL base + per-shape deviations
