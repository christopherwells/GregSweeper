...
export const PAR_MODEL = {
  // Last refit: 2026-08-16 | brms (5 users · max Rhat = 1.003, min ESS = 1480, divergent = 0/4000) | N=713 scores, 312 dates, 6 players | R²=0.550 (log scale)
  ...
  intercept: 2.9452,
  secPerCell: 0.00077,
  secPerMineFlag: 0.04798,
  secPerPatternMove: 0.03365,
  secPerSearchMove: 0.01196,
  secPerWallEdge: 0.00230,
  secPerZeroCluster: 0.00117,
  secPerMysteryCell: 0.00145,
  secPerLiarCell: 0.00136,
  secPerLockedCell: 0.04561,
  secPerWormholePair: 0.03777,
  secPerMirrorPair: 0.06061,
  secPerSonarCell: 0.06857,
  secPerCompassCell: 0.04857,
  secPerWormLoad: 0.00960,
};
// PAR_MODEL:END
...
export const PAR_MODEL_TIMED = {
  // Last refit: 2026-08-16 | brms-timed (n=146)
  // scale:"log" => par = exp(intercept + Σ coef·feature): multiplicative,
  // lognormal MEDIAN. Coefficients are LOG-MULTIPLIERS per unit, NOT seconds.
  ...
  intercept: 2.6690,
  secPerCell: 0.00143,
  secPerMineFlag: 0.04790,
  secPerPatternMove: 0.05267,
  secPerSearchMove: 0.01886,
  secPerWallEdge: 0.00295,
  secPerZeroCluster: 0.00161,
  secPerMysteryCell: 0.00183,
  secPerLiarCell: 0.00173,
  secPerLockedCell: 0.05760,
  secPerWormholePair: 0.04905,
  secPerMirrorPair: 0.07766,
  secPerSonarCell: 0.08809,
  secPerCompassCell: 0.06191,
  secPerWormLoad: 0.01202,
};
// TIMED_PAR_MODEL:END
...
export const PAR_MODEL_SHAPES = {
  ...
  '4.8.8': {
    ...
    intercept: 3.5298,
    secPerCell: 0.00058,
    secPerMineFlag: 0.02900,
    secPerPatternMove: 0.03365,
    secPerSearchMove: 0.01196,
    secPerWallEdge: 0.00230,
    secPerZeroCluster: 0.05239,
    secPerMysteryCell: 0.00145,
    secPerLiarCell: 0.00136,
    secPerLockedCell: 0.04561,
    secPerWormholePair: 0.03777,
  ...
  hex: {
    ...
    intercept: 2.8419,
    secPerCell: -0.00843,
    secPerMineFlag: 0.07211,
    secPerPatternMove: 0.03365,
    secPerSearchMove: 0.01196,
    secPerWallEdge: 0.00230,
    secPerZeroCluster: 0.05876,
    secPerMysteryCell: 0.00145,
    secPerLiarCell: 0.00136,
    secPerLockedCell: 0.04561,
    secPerWormholePair: 0.03777,
  ...
  cairo: {
    ...
    intercept: 2.5292,
    secPerCell: 0.02090,
    secPerMineFlag: 0.01991,
    secPerPatternMove: 0.03365,
    secPerSearchMove: 0.01196,
    secPerWallEdge: 0.00230,
    secPerZeroCluster: -0.04846,
    secPerMysteryCell: 0.00145,
    secPerLiarCell: 0.00136,
    secPerLockedCell: 0.04561,
    secPerWormholePair: 0.03777,
  ...
  floret: {
    ...
    intercept: 3.3975,
    secPerCell: -0.00077,
    secPerMineFlag: 0.06222,
    secPerPatternMove: 0.03365,
    secPerSearchMove: 0.01196,
    secPerWallEdge: 0.00230,
    secPerZeroCluster: -0.00340,
    secPerMysteryCell: 0.00145,
    secPerLiarCell: 0.00136,
    secPerLockedCell: 0.04561,
    secPerWormholePair: 0.03777,
  ...
  rhombille: {
    ...
    intercept: 2.6912,
    secPerCell: 0.01542,
    secPerMineFlag: 0.02726,
    secPerPatternMove: 0.03365,
    secPerSearchMove: 0.01196,
    secPerWallEdge: 0.00230,
    secPerZeroCluster: 0.16524,
    secPerMysteryCell: 0.00145,
    secPerLiarCell: 0.00136,
    secPerLockedCell: 0.04561,
    secPerWormholePair: 0.03777,
