...
export const PAR_MODEL = {
  // Last refit: 2026-08-14 | brms (5 users · max Rhat = 1.004, min ESS = 1363, divergent = 0/4000) | N=490 scores, 209 dates, 6 players | R²=0.426 (log scale)
  ...
  intercept: 3.0026,
  secPerCell: 0.00056,
  secPerMineFlag: 0.04870,
  secPerPatternMove: 0.02572,
  secPerSearchMove: 0.00936,
  secPerWallEdge: 0.00197,
  secPerZeroCluster: 0.00110,
  secPerMysteryCell: 0.00150,
  secPerLiarCell: 0.00126,
  secPerLockedCell: 0.03564,
  secPerWormholePair: 0.03551,
  secPerMirrorPair: 0.03804,
  secPerSonarCell: 0.05776,
  secPerCompassCell: 0.03562,
  secPerWormLoad: 0.01079,
};
// PAR_MODEL:END
...
export const PAR_MODEL_TIMED = {
  // Last refit: 2026-08-14 | brms-timed (n=143)
  // scale:"log" => par = exp(intercept + Σ coef·feature): multiplicative,
  // lognormal MEDIAN. Coefficients are LOG-MULTIPLIERS per unit, NOT seconds.
  ...
  secPerPatternMove: 0.05069,
  secPerSearchMove: 0.01694,
  secPerWallEdge: 0.00253,
  secPerZeroCluster: 0.00150,
  secPerMysteryCell: 0.00188,
  secPerLiarCell: 0.00162,
  secPerLockedCell: 0.04590,
  secPerWormholePair: 0.04552,
  secPerMirrorPair: 0.04771,
  secPerSonarCell: 0.07381,
  secPerCompassCell: 0.04504,
  secPerWormLoad: 0.01378,
};
// TIMED_PAR_MODEL:END
...
export const PAR_MODEL_SHAPES = {
  // Last refit: 2026-08-14 | composed: PAR_MODEL base + per-shape deviations
