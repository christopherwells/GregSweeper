...
export const PAR_MODEL = {
  // Last refit: 2026-08-05 | brms (4 users · max Rhat = 1.004, min ESS = 1222, divergent = 0/4000) | N=392 scores, 163 dates, 5 players | R²=0.494 (log scale)
  ...
  intercept: 3.0228,
  secPerCell: 0.00056,
  secPerMineFlag: 0.04936,
  secPerPatternMove: 0.02012,
  secPerSearchMove: 0.01288,
  secPerWallEdge: 0.00170,
  secPerZeroCluster: 0.00106,
  secPerMysteryCell: 0.00135,
  secPerLiarCell: 0.00128,
  secPerLockedCell: 0.02586,
  secPerWormholePair: 0.00174,
  secPerMirrorPair: 0.02083,
  secPerSonarCell: 0.05203,
  secPerCompassCell: 0.02257,
  secPerWormLoad: 0.00647,
};
// PAR_MODEL:END
...
export const PAR_MODEL_TIMED = {
  // Last refit: 2026-08-05 | brms-timed (n=134)
  // scale:"log" => par = exp(intercept + Σ coef·feature): multiplicative,
  // lognormal MEDIAN. Coefficients are LOG-MULTIPLIERS per unit, NOT seconds.
  ...
  intercept: 2.6982,
  secPerCell: 0.00137,
  secPerMineFlag: 0.04719,
  secPerPatternMove: 0.04874,
  secPerSearchMove: 0.01849,
  secPerWallEdge: 0.00217,
  secPerZeroCluster: 0.00144,
  secPerMysteryCell: 0.00173,
  secPerLiarCell: 0.00163,
  secPerLockedCell: 0.03346,
  secPerWormholePair: 0.00222,
  secPerMirrorPair: 0.02637,
  secPerSonarCell: 0.06659,
  secPerCompassCell: 0.02911,
  secPerWormLoad: 0.00824,
};
// TIMED_PAR_MODEL:END
...
export const PAR_MODEL_SHAPES = {
  // Last refit: 2026-08-05 | composed: PAR_MODEL base + per-shape deviations
