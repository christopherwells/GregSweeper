...
export const PAR_MODEL = {
  // Last refit: 2026-08-17 | brms (5 users · max Rhat = 1.004, min ESS = 1401, divergent = 0/4000) | N=741 scores, 326 dates, 6 players | R²=0.517 (log scale)
  ...
  intercept: 2.9478,
  secPerCell: 0.00074,
  secPerMineFlag: 0.04778,
  secPerPatternMove: 0.03427,
  secPerSearchMove: 0.01235,
  secPerWallEdge: 0.00215,
  secPerZeroCluster: 0.00329,
  secPerMysteryCell: 0.00144,
  secPerLiarCell: 0.00136,
  secPerLockedCell: 0.04463,
  secPerWormholePair: 0.03805,
  secPerMirrorPair: 0.06038,
  secPerSonarCell: 0.06598,
  secPerCompassCell: 0.04905,
  secPerWormLoad: 0.01023,
};
// PAR_MODEL:END
...
export const PAR_MODEL_TIMED = {
  // Last refit: 2026-08-17 | brms-timed (n=146)
  // scale:"log" => par = exp(intercept + Σ coef·feature): multiplicative,
  // lognormal MEDIAN. Coefficients are LOG-MULTIPLIERS per unit, NOT seconds.
  ...
  intercept: 2.6737,
  secPerCell: 0.00142,
  secPerMineFlag: 0.04746,
  secPerPatternMove: 0.05244,
  secPerSearchMove: 0.01895,
  secPerWallEdge: 0.00274,
  secPerZeroCluster: 0.00569,
  secPerMysteryCell: 0.00186,
  secPerLiarCell: 0.00176,
  secPerLockedCell: 0.05700,
  secPerWormholePair: 0.04856,
  secPerMirrorPair: 0.07628,
  secPerSonarCell: 0.08444,
  secPerCompassCell: 0.06279,
  secPerWormLoad: 0.01285,
};
// TIMED_PAR_MODEL:END
...
export const PAR_MODEL_SHAPES = {
  // Last refit: 2026-08-17 | composed: PAR_MODEL base + per-shape deviations
  ...
  '4.8.8': {
    ...
    intercept: 3.4286,
    secPerCell: 0.00508,
    secPerMineFlag: 0.01654,
    secPerPatternMove: 0.03427,
    secPerSearchMove: 0.01235,
    secPerWallEdge: 0.00215,
    secPerZeroCluster: 0.04540,
    secPerMysteryCell: 0.00144,
    secPerLiarCell: 0.00136,
    secPerLockedCell: 0.04463,
    secPerWormholePair: 0.03805,
  ...
  hex: {
    ...
    intercept: 2.7987,
    secPerCell: -0.00775,
    secPerMineFlag: 0.06901,
    secPerPatternMove: 0.03427,
    secPerSearchMove: 0.01235,
    secPerWallEdge: 0.00215,
    secPerZeroCluster: 0.05866,
    secPerMysteryCell: 0.00144,
    secPerLiarCell: 0.00136,
    secPerLockedCell: 0.04463,
    secPerWormholePair: 0.03805,
    ...
    secPerSonarCell: 0.06598,
    secPerCompassCell: 0.04905,
    secPerWormLoad: 0.02043,
  },
  cairo: {
    scale: 'log',
    intercept: 2.5423,
    secPerCell: 0.02093,
    secPerMineFlag: 0.01983,
    secPerPatternMove: 0.03427,
    secPerSearchMove: 0.01235,
    secPerWallEdge: 0.00215,
    secPerZeroCluster: -0.04794,
    secPerMysteryCell: 0.00144,
    secPerLiarCell: 0.00136,
    secPerLockedCell: 0.04463,
    secPerWormholePair: 0.03805,
  ...
  floret: {
    ...
    intercept: 3.3449,
    secPerCell: 0.00237,
    secPerMineFlag: 0.05826,
    secPerPatternMove: 0.03427,
    secPerSearchMove: 0.01235,
    secPerWallEdge: 0.00215,
    secPerZeroCluster: -0.06979,
    secPerMysteryCell: 0.00144,
    secPerLiarCell: 0.00136,
    secPerLockedCell: 0.04463,
    secPerWormholePair: 0.03805,
  ...
  rhombille: {
    ...
    intercept: 3.2445,
    secPerCell: 0.02030,
    secPerMineFlag: -0.03475,
    secPerPatternMove: 0.03427,
    secPerSearchMove: 0.01235,
    secPerWallEdge: 0.00215,
    secPerZeroCluster: 0.19781,
    secPerMysteryCell: 0.00144,
    secPerLiarCell: 0.00136,
    secPerLockedCell: 0.04463,
    secPerWormholePair: 0.03805,
