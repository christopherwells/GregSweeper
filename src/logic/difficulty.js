...
export const PAR_MODEL = {
  // Last refit: 2026-08-18 | brms (5 users · max Rhat = 1.004, min ESS = 1356, divergent = 0/4000) | N=789 scores, 354 dates, 6 players | R²=0.531 (log scale)
  ...
  intercept: 2.9304,
  secPerCell: 0.00074,
  secPerMineFlag: 0.04821,
  secPerPatternMove: 0.03529,
  secPerSearchMove: 0.01345,
  secPerWallEdge: 0.00225,
  secPerZeroCluster: 0.00489,
  secPerMysteryCell: 0.00145,
  secPerLiarCell: 0.00133,
  secPerLockedCell: 0.04324,
  secPerWormholePair: 0.03894,
  secPerMirrorPair: 0.06270,
  secPerSonarCell: 0.06384,
  secPerCompassCell: 0.04847,
  secPerWormLoad: 0.01069,
};
// PAR_MODEL:END
...
export const PAR_MODEL_TIMED = {
  ...
  intercept: 2.6715,
  secPerCell: 0.00147,
  secPerMineFlag: 0.04666,
  secPerPatternMove: 0.05256,
  secPerSearchMove: 0.01975,
  secPerWallEdge: 0.00286,
  secPerZeroCluster: 0.00951,
  secPerMysteryCell: 0.00184,
  secPerLiarCell: 0.00167,
  secPerLockedCell: 0.05524,
  secPerWormholePair: 0.05037,
  secPerMirrorPair: 0.07956,
  secPerSonarCell: 0.07980,
  secPerCompassCell: 0.06166,
  secPerWormLoad: 0.01376,
};
// TIMED_PAR_MODEL:END
...
export const PAR_MODEL_SHAPES = {
  ...
  '4.8.8': {
    ...
    intercept: 3.3922,
    secPerCell: 0.00543,
    secPerMineFlag: 0.01682,
    secPerPatternMove: 0.03529,
    secPerSearchMove: 0.01345,
    secPerWallEdge: 0.00225,
    secPerZeroCluster: 0.04965,
    secPerMysteryCell: 0.00145,
    secPerLiarCell: 0.00133,
    secPerLockedCell: 0.04324,
    secPerWormholePair: 0.03894,
  ...
  hex: {
    ...
    intercept: 2.8106,
    secPerCell: -0.00770,
    secPerMineFlag: 0.06903,
    secPerPatternMove: 0.03529,
    secPerSearchMove: 0.01345,
    secPerWallEdge: 0.00225,
    secPerZeroCluster: 0.05796,
    secPerMysteryCell: 0.00145,
    secPerLiarCell: 0.00133,
    secPerLockedCell: 0.04324,
    secPerWormholePair: 0.03894,
    ...
    secPerSonarCell: 0.06384,
    secPerCompassCell: 0.04847,
    secPerWormLoad: 0.02139,
  },
  cairo: {
    scale: 'log',
    intercept: 2.5698,
    secPerCell: 0.02060,
    secPerMineFlag: 0.02079,
    secPerPatternMove: 0.03529,
    secPerSearchMove: 0.01345,
    secPerWallEdge: 0.00225,
    secPerZeroCluster: -0.04592,
    secPerMysteryCell: 0.00145,
    secPerLiarCell: 0.00133,
    secPerLockedCell: 0.04324,
    secPerWormholePair: 0.03894,
  ...
  floret: {
    ...
    intercept: 3.1871,
    secPerCell: 0.00080,
    secPerMineFlag: 0.06664,
    secPerPatternMove: 0.08470,
    secPerSearchMove: 0.01345,
    secPerWallEdge: 0.00225,
    secPerZeroCluster: 0.02270,
    secPerMysteryCell: 0.00145,
    secPerLiarCell: 0.00133,
    secPerLockedCell: 0.04324,
    secPerWormholePair: 0.03894,
  ...
  rhombille: {
    ...
    intercept: 3.3981,
    secPerCell: 0.00999,
    secPerMineFlag: -0.01473,
    secPerPatternMove: 0.03529,
    secPerSearchMove: 0.01345,
    secPerWallEdge: 0.00225,
    secPerZeroCluster: 0.28565,
    secPerMysteryCell: 0.00145,
    secPerLiarCell: 0.00133,
    secPerLockedCell: 0.04324,
    secPerWormholePair: 0.03894,
  ...
  deltoidal: {
    ...
    intercept: 3.1953,
    secPerCell: 0.00084,
    secPerMineFlag: 0.09369,
    secPerPatternMove: 0.03529,
    secPerSearchMove: 0.01345,
    secPerWallEdge: 0.00225,
    secPerZeroCluster: 0.01298,
    secPerMysteryCell: 0.00145,
    secPerLiarCell: 0.00133,
    secPerLockedCell: 0.04324,
    secPerWormholePair: 0.03894,
