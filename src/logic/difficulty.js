...
export const PAR_MODEL = {
  // Last refit: 2026-08-21 | brms (5 users · max Rhat = 1.004, min ESS = 917, divergent = 0/4000) | N=883 scores, 405 dates, 6 players | R²=0.416 (log scale)
  ...
  scale: 'log',
  intercept: -2.2570,
  secPerLogCell: 1.13015,
  secPerMineRate: 4.85221,
  secPerPatternRate: 4.77630,
  secPerSearchRate: 1.42681,
  secPerWallEdge: 0.00580,
  secPerZeroCluster: 0.01448,
  secPerMysteryCell: 0.02044,
  secPerLiarCell: 0.00150,
  secPerLockedCell: 0.05194,
  secPerWormholePair: 0.05762,
  secPerMirrorPair: 0.07017,
  secPerSonarCell: 0.06129,
  secPerCompassCell: 0.05478,
  secPerWormLoad: 0.01061,
};
// PAR_MODEL:END
...
export const PAR_MODEL_TIMED = {
  // Last refit: 2026-08-21 | brms-timed (n=145)
  // scale:"log" => par = exp(intercept + Σ coef·feature): multiplicative,
  // lognormal MEDIAN. Coefficients are LOG-MULTIPLIERS per unit, NOT seconds.
  ...
  secPerWallEdge: 0.00740,
  secPerZeroCluster: 0.03338,
  secPerMysteryCell: 0.02636,
  secPerLiarCell: 0.00192,
  secPerLockedCell: 0.06511,
  secPerWormholePair: 0.07182,
  secPerMirrorPair: 0.08835,
  secPerSonarCell: 0.07855,
  secPerCompassCell: 0.07000,
  secPerWormLoad: 0.01347,
};
// TIMED_PAR_MODEL:END
...
export const PAR_MODEL_SHAPES = {
  // Last refit: 2026-08-21 | composed: PAR_MODEL base + per-shape deviations
  ...
  '4.8.8': {
    scale: 'log',
    intercept: -1.9251,
    secPerLogCell: 1.13919,
    secPerMineRate: 4.46062,
    secPerPatternRate: 4.77630,
    secPerSearchRate: 1.42681,
    secPerWallEdge: 0.00580,
    secPerZeroCluster: 0.03110,
    secPerMysteryCell: 0.02044,
    secPerLiarCell: 0.00150,
    secPerLockedCell: 0.05194,
    secPerWormholePair: 0.05762,
    ...
    secPerSonarCell: 0.06129,
    secPerCompassCell: 0.05478,
    secPerWormLoad: -0.00654,
  },
  hex: {
    scale: 'log',
    intercept: -2.4449,
    secPerLogCell: 1.00557,
    secPerMineRate: 5.68942,
    secPerPatternRate: 4.77630,
    secPerSearchRate: 1.42681,
    secPerWallEdge: 0.00580,
    secPerZeroCluster: 0.06516,
    secPerMysteryCell: 0.02044,
    secPerLiarCell: 0.00150,
    secPerLockedCell: 0.05194,
    secPerWormholePair: 0.05762,
    ...
    secPerSonarCell: 0.06129,
    secPerCompassCell: 0.05478,
    secPerWormLoad: 0.03074,
  },
  cairo: {
    scale: 'log',
    intercept: -2.3322,
    secPerLogCell: 1.18816,
    secPerMineRate: 5.38576,
    secPerPatternRate: 4.81503,
    secPerSearchRate: 1.42681,
    secPerWallEdge: 0.00580,
    secPerZeroCluster: 0.07671,
    secPerMysteryCell: 0.02044,
    secPerLiarCell: 0.00150,
    secPerLockedCell: 0.05194,
    secPerWormholePair: 0.05762,
  ...
  floret: {
    scale: 'log',
    intercept: -2.3901,
    secPerLogCell: 1.29269,
    secPerMineRate: 4.90382,
    secPerPatternRate: 5.06123,
    secPerSearchRate: 1.42681,
    secPerWallEdge: 0.00580,
    secPerZeroCluster: 0.03506,
    secPerMysteryCell: 0.02044,
    secPerLiarCell: 0.00150,
    secPerLockedCell: 0.05194,
    secPerWormholePair: 0.05762,
  ...
  rhombille: {
    scale: 'log',
    intercept: -1.7600,
    secPerLogCell: 1.06192,
    secPerMineRate: 4.74117,
    secPerPatternRate: 4.77630,
    secPerSearchRate: 1.42681,
    secPerWallEdge: 0.00580,
    secPerZeroCluster: 0.27812,
    secPerMysteryCell: 0.02044,
    secPerLiarCell: 0.00150,
    secPerLockedCell: 0.05194,
    secPerWormholePair: 0.05762,
  ...
  deltoidal: {
    scale: 'log',
    intercept: -2.4904,
    secPerLogCell: 1.31039,
    secPerMineRate: 4.96515,
    secPerPatternRate: 4.82122,
    secPerSearchRate: 1.52131,
    secPerWallEdge: 0.00580,
    secPerZeroCluster: 0.07128,
    secPerMysteryCell: 0.02044,
    secPerLiarCell: 0.00150,
    secPerLockedCell: 0.05194,
    secPerWormholePair: 0.05762,
