...
export const PAR_MODEL = {
  // Last refit: 2026-08-15 | brms (5 users · max Rhat = 1.002, min ESS = 1357, divergent = 0/4000) | N=567 scores, 252 dates, 6 players | R²=0.467 (log scale)
  ...
  intercept: 2.9806,
  secPerCell: 0.00057,
  secPerMineFlag: 0.04796,
  secPerPatternMove: 0.03003,
  secPerSearchMove: 0.01192,
  secPerWallEdge: 0.00235,
  secPerZeroCluster: 0.00110,
  secPerMysteryCell: 0.00150,
  secPerLiarCell: 0.00137,
  secPerLockedCell: 0.03910,
  secPerWormholePair: 0.03619,
  secPerMirrorPair: 0.05716,
  secPerSonarCell: 0.07174,
  secPerCompassCell: 0.04242,
  secPerWormLoad: 0.00987,
};
// PAR_MODEL:END
...
export const PAR_MODEL_TIMED = {
  // Last refit: 2026-08-15 | brms-timed (n=143)
  // scale:"log" => par = exp(intercept + Σ coef·feature): multiplicative,
  // lognormal MEDIAN. Coefficients are LOG-MULTIPLIERS per unit, NOT seconds.
  ...
  intercept: 2.6888,
  secPerCell: 0.00138,
  secPerMineFlag: 0.04665,
  secPerPatternMove: 0.05101,
  secPerSearchMove: 0.01911,
  secPerWallEdge: 0.00300,
  secPerZeroCluster: 0.00149,
  secPerMysteryCell: 0.00188,
  secPerLiarCell: 0.00175,
  secPerLockedCell: 0.05040,
  secPerWormholePair: 0.04641,
  secPerMirrorPair: 0.07016,
  secPerSonarCell: 0.09117,
  secPerCompassCell: 0.05405,
  secPerWormLoad: 0.01231,
};
// TIMED_PAR_MODEL:END
...
export const PAR_MODEL_SHAPES = {
  // Last refit: 2026-08-15 | composed: PAR_MODEL base + per-shape deviations
  ...
  hex: {
    ...
    intercept: 2.6916,
    secPerCell: 0.00064,
    secPerMineFlag: 0.08401,
    secPerPatternMove: 0.03003,
    secPerSearchMove: 0.01192,
    secPerWallEdge: 0.00235,
    secPerZeroCluster: -0.06746,
    secPerMysteryCell: 0.00150,
    secPerLiarCell: 0.00137,
    secPerLockedCell: 0.03910,
    secPerWormholePair: 0.03619,
  ...
  cairo: {
    ...
    intercept: 2.6667,
    secPerCell: 0.02114,
    secPerMineFlag: 0.01771,
    secPerPatternMove: 0.03003,
    secPerSearchMove: 0.01192,
    secPerWallEdge: 0.00235,
    secPerZeroCluster: -0.04529,
    secPerMysteryCell: 0.00150,
    secPerLiarCell: 0.00137,
    secPerLockedCell: 0.03910,
    secPerWormholePair: 0.03619,
