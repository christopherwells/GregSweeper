...
export const PAR_MODEL = {
  // Last refit: 2026-08-18 | brms (5 users · max Rhat = 1.007, min ESS = 990, divergent = 0/4000) | N=797 scores, 356 dates, 6 players | R²=0.534 (log scale)
  ...
  intercept: 0.5554,
  secPerCell: -0.00671,
  secPerLogCell: 0.68293,
  secPerMineFlag: 0.04738,
  secPerPatternMove: 0.03614,
  secPerSearchMove: 0.01395,
  secPerWallEdge: 0.00271,
  secPerZeroCluster: 0.00527,
  secPerMysteryCell: 0.00159,
  secPerLiarCell: 0.00136,
  secPerLockedCell: 0.04626,
  secPerWormholePair: 0.03971,
  secPerMirrorPair: 0.06214,
  secPerSonarCell: 0.07019,
  secPerCompassCell: 0.05032,
  secPerWormLoad: 0.01086,
};
// PAR_MODEL:END
...
export const PAR_MODEL_TIMED = {
  ...
  secPerMineFlag: 0.04667,
  secPerPatternMove: 0.05258,
  secPerSearchMove: 0.02005,
  secPerWallEdge: 0.00347,
  secPerZeroCluster: 0.01036,
  secPerMysteryCell: 0.00204,
  secPerLiarCell: 0.00176,
  secPerLockedCell: 0.05935,
  secPerWormholePair: 0.05083,
  secPerMirrorPair: 0.08133,
  secPerSonarCell: 0.08903,
  secPerCompassCell: 0.06336,
  secPerWormLoad: 0.01391,
};
// TIMED_PAR_MODEL:END
...
export const PAR_MODEL_SHAPES = {
  ...
  '4.8.8': {
    ...
    intercept: 0.5068,
    secPerCell: -0.00822,
    secPerLogCell: 0.89128,
    secPerMineFlag: 0.01610,
    secPerPatternMove: 0.03614,
    secPerSearchMove: 0.01395,
    secPerWallEdge: 0.00271,
    secPerZeroCluster: 0.05854,
    secPerMysteryCell: 0.00159,
    secPerLiarCell: 0.00136,
    secPerLockedCell: 0.04626,
    secPerWormholePair: 0.03971,
  ...
  hex: {
    ...
    intercept: 0.1188,
    secPerCell: -0.01701,
    secPerLogCell: 0.76861,
    secPerMineFlag: 0.07160,
    secPerPatternMove: 0.03614,
    secPerSearchMove: 0.01395,
    secPerWallEdge: 0.00271,
    secPerZeroCluster: 0.05462,
    secPerMysteryCell: 0.00159,
    secPerLiarCell: 0.00136,
    secPerLockedCell: 0.04626,
    secPerWormholePair: 0.03971,
    ...
    secPerSonarCell: 0.07019,
    secPerCompassCell: 0.05032,
    secPerWormLoad: 0.02262,
  },
  cairo: {
    scale: 'log',
    intercept: 0.2138,
    secPerCell: 0.01131,
    secPerLogCell: 0.70903,
    secPerMineFlag: 0.02157,
    secPerPatternMove: 0.03614,
    secPerSearchMove: 0.01395,
    secPerWallEdge: 0.00271,
    secPerZeroCluster: -0.05815,
    secPerMysteryCell: 0.00159,
    secPerLiarCell: 0.00136,
    secPerLockedCell: 0.04626,
    secPerWormholePair: 0.03971,
  ...
  floret: {
    ...
    intercept: 0.5513,
    secPerCell: -0.01038,
    secPerLogCell: 0.79927,
    secPerMineFlag: 0.06643,
    secPerPatternMove: 0.08947,
    secPerSearchMove: 0.01395,
    secPerWallEdge: 0.00271,
    secPerZeroCluster: 0.01786,
    secPerMysteryCell: 0.00159,
    secPerLiarCell: 0.00136,
    secPerLockedCell: 0.04626,
    secPerWormholePair: 0.03971,
  ...
  rhombille: {
    ...
    intercept: 0.7871,
    secPerCell: -0.00087,
    secPerLogCell: 0.79001,
    secPerMineFlag: -0.01156,
    secPerPatternMove: 0.03614,
    secPerSearchMove: 0.01395,
    secPerWallEdge: 0.00271,
    secPerZeroCluster: 0.26094,
    secPerMysteryCell: 0.00159,
    secPerLiarCell: 0.00136,
    secPerLockedCell: 0.04626,
    secPerWormholePair: 0.03971,
  ...
  deltoidal: {
    ...
    intercept: 0.9811,
    secPerCell: -0.01106,
    secPerLogCell: 0.72467,
    secPerMineFlag: 0.07109,
    secPerPatternMove: 0.11630,
    secPerSearchMove: 0.02627,
    secPerWallEdge: 0.00271,
    secPerZeroCluster: 0.10375,
    secPerMysteryCell: 0.00159,
    secPerLiarCell: 0.00136,
    secPerLockedCell: 0.04626,
    secPerWormholePair: 0.03971,
