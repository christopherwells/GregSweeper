...
export const PAR_MODEL = {
  // Last refit: 2026-08-20 | brms (5 users · max Rhat = 1.005, min ESS = 1234, divergent = 0/4000) | N=844 scores, 377 dates, 6 players | R²=0.540 (log scale)
  ...
  intercept: 0.2520,
  secPerCell: -0.00723,
  secPerLogCell: 0.76277,
  secPerMineFlag: 0.04714,
  secPerPatternMove: 0.03603,
  secPerSearchMove: 0.01351,
  secPerWallEdge: 0.00308,
  secPerZeroCluster: 0.00372,
  secPerMysteryCell: 0.00170,
  secPerLiarCell: 0.00138,
  secPerLockedCell: 0.04731,
  secPerWormholePair: 0.04732,
  secPerMirrorPair: 0.06201,
  secPerSonarCell: 0.07243,
  secPerCompassCell: 0.05123,
  secPerWormLoad: 0.01051,
};
// PAR_MODEL:END
...
export const PAR_MODEL_TIMED = {
  ...
  secPerMineFlag: 0.04671,
  secPerPatternMove: 0.05206,
  secPerSearchMove: 0.02019,
  secPerWallEdge: 0.00395,
  secPerZeroCluster: 0.00655,
  secPerMysteryCell: 0.00216,
  secPerLiarCell: 0.00176,
  secPerLockedCell: 0.06067,
  secPerWormholePair: 0.06072,
  secPerMirrorPair: 0.07827,
  secPerSonarCell: 0.09199,
  secPerCompassCell: 0.06411,
  secPerWormLoad: 0.01371,
};
// TIMED_PAR_MODEL:END
...
export const PAR_MODEL_SHAPES = {
  ...
  '4.8.8': {
    ...
    intercept: 0.2117,
    secPerCell: -0.00927,
    secPerLogCell: 0.98025,
    secPerMineFlag: 0.01610,
    secPerPatternMove: 0.03603,
    secPerSearchMove: 0.01351,
    secPerWallEdge: 0.00308,
    secPerZeroCluster: 0.05849,
    secPerMysteryCell: 0.00170,
    secPerLiarCell: 0.00138,
    secPerLockedCell: 0.04731,
    secPerWormholePair: 0.04732,
  ...
  hex: {
    ...
    intercept: -0.1656,
    secPerCell: -0.01767,
    secPerLogCell: 0.84646,
    secPerMineFlag: 0.07150,
    secPerPatternMove: 0.03603,
    secPerSearchMove: 0.01351,
    secPerWallEdge: 0.00308,
    secPerZeroCluster: 0.05461,
    secPerMysteryCell: 0.00170,
    secPerLiarCell: 0.00138,
    secPerLockedCell: 0.04731,
    secPerWormholePair: 0.04732,
    ...
    secPerSonarCell: 0.07243,
    secPerCompassCell: 0.05123,
    secPerWormLoad: 0.02243,
  },
  cairo: {
    scale: 'log',
    intercept: -0.0163,
    secPerCell: 0.00378,
    secPerLogCell: 0.87323,
    secPerMineFlag: 0.03349,
    secPerPatternMove: 0.04989,
    secPerSearchMove: 0.01351,
    secPerWallEdge: 0.00308,
    secPerZeroCluster: -0.07153,
    secPerMysteryCell: 0.00170,
    secPerLiarCell: 0.00138,
    secPerLockedCell: 0.04731,
    secPerWormholePair: 0.04732,
  ...
  floret: {
    ...
    intercept: 0.0720,
    secPerCell: -0.00909,
    secPerLogCell: 0.86364,
    secPerMineFlag: 0.06223,
    secPerPatternMove: 0.08339,
    secPerSearchMove: 0.01351,
    secPerWallEdge: 0.00308,
    secPerZeroCluster: 0.08516,
    secPerMysteryCell: 0.00170,
    secPerLiarCell: 0.00138,
    secPerLockedCell: 0.04731,
    secPerWormholePair: 0.04732,
  ...
  rhombille: {
    ...
    intercept: 0.4021,
    secPerCell: 0.01657,
    secPerLogCell: 0.84549,
    secPerMineFlag: -0.06449,
    secPerPatternMove: 0.03603,
    secPerSearchMove: 0.01351,
    secPerWallEdge: 0.00308,
    secPerZeroCluster: 0.24185,
    secPerMysteryCell: 0.00170,
    secPerLiarCell: 0.00138,
    secPerLockedCell: 0.04731,
    secPerWormholePair: 0.04732,
  ...
  deltoidal: {
    ...
    intercept: 0.3955,
    secPerCell: 0.00073,
    secPerLogCell: 0.66097,
    secPerMineFlag: 0.06326,
    secPerPatternMove: 0.16518,
    secPerSearchMove: 0.05255,
    secPerWallEdge: 0.00308,
    secPerZeroCluster: 0.06110,
    secPerMysteryCell: 0.00170,
    secPerLiarCell: 0.00138,
    secPerLockedCell: 0.04731,
    secPerWormholePair: 0.04732,
