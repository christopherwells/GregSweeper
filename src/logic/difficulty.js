...
export const PAR_MODEL = {
  // Last refit: 2026-08-08 | brms (4 users · max Rhat = 1.004, min ESS = 988, divergent = 0/4000) | N=402 scores, 165 dates, 6 players | R²=0.494 (log scale)
  ...
  intercept: 3.0049,
  secPerCell: 0.00053,
  secPerMineFlag: 0.04957,
  secPerPatternMove: 0.02142,
  secPerSearchMove: 0.01289,
  secPerWallEdge: 0.00183,
  secPerZeroCluster: 0.00109,
  secPerMysteryCell: 0.00138,
  secPerLiarCell: 0.00128,
  secPerLockedCell: 0.02884,
  secPerWormholePair: 0.00171,
  secPerMirrorPair: 0.02725,
  secPerSonarCell: 0.05416,
  secPerCompassCell: 0.02469,
  secPerWormLoad: 0.00678,
};
// PAR_MODEL:END
...
export const PAR_MODEL_TIMED = {
  // Last refit: 2026-08-08 | brms-timed (n=138)
  // scale:"log" => par = exp(intercept + Σ coef·feature): multiplicative,
  // lognormal MEDIAN. Coefficients are LOG-MULTIPLIERS per unit, NOT seconds.
  ...
  intercept: 2.6978,
  secPerCell: 0.00135,
  secPerMineFlag: 0.04706,
  secPerPatternMove: 0.04975,
  secPerSearchMove: 0.01795,
  secPerWallEdge: 0.00230,
  secPerZeroCluster: 0.00147,
  secPerMysteryCell: 0.00171,
  secPerLiarCell: 0.00164,
  secPerLockedCell: 0.03747,
  secPerWormholePair: 0.00215,
  secPerMirrorPair: 0.03461,
  secPerSonarCell: 0.06868,
  secPerCompassCell: 0.03103,
  secPerWormLoad: 0.00854,
};
// TIMED_PAR_MODEL:END
...
export const PAR_MODEL_SHAPES = {
  // Last refit: 2026-08-08 | composed: PAR_MODEL base + per-shape deviations
