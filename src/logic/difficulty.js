...
export const PAR_MODEL = {
  // Last refit: 2026-08-04 | brms (4 users · max Rhat = 1.002, min ESS = 1371, divergent = 0/4000) | N=388 scores, 162 dates, 5 players | R²=0.498 (log scale)
  ...
  secPerPatternMove: 0.02069,
  secPerSearchMove: 0.01287,
  secPerWallEdge: 0.00166,
  secPerZeroCluster: 0.00105,
  secPerMysteryCell: 0.00135,
  secPerLiarCell: 0.00129,
  secPerLockedCell: 0.02394,
  secPerWormholePair: 0.00391,
  secPerMirrorPair: 0.02229,
  secPerSonarCell: 0.05172,
  secPerCompassCell: 0.02391,
  secPerWormLoad: 0.00676,
};
// PAR_MODEL:END
...
export const PAR_MODEL_TIMED = {
  ...
  intercept: 2.6978,
  secPerCell: 0.00136,
  secPerMineFlag: 0.04709,
  secPerPatternMove: 0.04832,
  secPerSearchMove: 0.01900,
  secPerWallEdge: 0.00214,
  secPerZeroCluster: 0.00144,
  secPerMysteryCell: 0.00172,
  secPerLiarCell: 0.00165,
  secPerLockedCell: 0.03057,
  secPerWormholePair: 0.00504,
  secPerMirrorPair: 0.02836,
  secPerSonarCell: 0.06463,
  secPerCompassCell: 0.03035,
  secPerWormLoad: 0.00858,
};
// TIMED_PAR_MODEL:END
