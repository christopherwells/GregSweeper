...
export const PAR_MODEL = {
  // Last refit: 2026-07-10 | brms (4 users · max Rhat = 1.003, min ESS = 1039, divergent = 0/4000) | N=285 scores, 123 dates, 5 players | R²=0.483 (log scale)
  ...
  secPerCell:        0.00068,
  secPerMineFlag:    0.05801,

  // Reasoning tiers: pattern = canonical + generic subsets; search = advanced.
  secPerPatternMove: 0.00938,
  secPerSearchMove:  0.00650,

  // Board structure.
  secPerWallEdge:    0.00161,
  secPerZeroCluster: 0.00115,

  // Modifier cells (kept split; sparse, prior-anchored until data builds).
  secPerMysteryCell:   0.00140,
  secPerLiarCell:      0.00146,
  secPerLockedCell:    0.02878,
  secPerWormholePair:  0.00152,
  secPerMirrorPair:    0.02501,
  secPerSonarCell:     0.03708,
  secPerCompassCell:   0.03340,
...
export const PAR_MODEL_TIMED = {
  // Last refit: 2026-07-10 | brms-timed (n=82)
  ...
  intercept: 2.5027,
  secPerCell:        0.00136,
  secPerMineFlag:    0.05857,
  secPerPatternMove: 0.04695,
  secPerSearchMove:  0.01002,
  secPerWallEdge:    0.00206,
  secPerZeroCluster: 0.00151,
  secPerMysteryCell:   0.00177,
  secPerLiarCell:      0.00187,
  secPerLockedCell:    0.03629,
  secPerWormholePair:  0.00192,
  secPerMirrorPair:    0.03228,
  secPerSonarCell:     0.04781,
  secPerCompassCell:   0.04290,
};
// TIMED_PAR_MODEL:END
