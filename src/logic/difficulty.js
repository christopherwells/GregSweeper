...
export const PAR_MODEL = {
  // Last refit: 2026-05-13 | brms (2 users · max Rhat = 1.002, min ESS = 1196, divergent = 0/4000) | N=129 scores, 65 dates, 3 players | R²=0.612
  intercept: -12.04,
