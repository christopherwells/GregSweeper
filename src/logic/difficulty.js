...
export const PAR_MODEL = {
  // Last refit: 2026-08-09 | brms (5 users · max Rhat = 1.004, min ESS = 1419, divergent = 0/4000) | N=407 scores, 167 dates, 6 players | R²=0.465 (log scale)
  ...
  intercept: 3.0165,
  secPerCell: 0.00054,
  secPerMineFlag: 0.04891,
  secPerPatternMove: 0.02114,
  secPerSearchMove: 0.01328,
  secPerWallEdge: 0.00187,
  secPerZeroCluster: 0.00107,
  secPerMysteryCell: 0.00138,
  secPerLiarCell: 0.00125,
  secPerLockedCell: 0.03200,
  secPerWormholePair: 0.02642,
  secPerMirrorPair: 0.02724,
  secPerSonarCell: 0.05531,
  secPerCompassCell: 0.02665,
...
export const PAR_MODEL_TIMED = {
  // Last refit: 2026-08-09 | brms-timed (n=142)
  // scale:"log" => par = exp(intercept + Σ coef·feature): multiplicative,
  // lognormal MEDIAN. Coefficients are LOG-MULTIPLIERS per unit, NOT seconds.
  ...
  intercept: 2.6829,
  secPerCell: 0.00138,
  secPerMineFlag: 0.04754,
  secPerPatternMove: 0.04981,
  secPerSearchMove: 0.01836,
  secPerWallEdge: 0.00240,
  secPerZeroCluster: 0.00143,
  secPerMysteryCell: 0.00183,
  secPerLiarCell: 0.00159,
  secPerLockedCell: 0.04058,
  secPerWormholePair: 0.03345,
  secPerMirrorPair: 0.03450,
  secPerSonarCell: 0.07072,
  secPerCompassCell: 0.03457,
  secPerWormLoad: 0.01032,
};
// TIMED_PAR_MODEL:END
