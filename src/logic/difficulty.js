...
export const PAR_MODEL = {
  // Last refit: 2026-08-10 | brms (5 users · max Rhat = 1.006, min ESS = 1117, divergent = 0/4000) | N=413 scores, 169 dates, 6 players | R²=0.468 (log scale)
  ...
  intercept: 3.0138,
  secPerCell: 0.00055,
  secPerMineFlag: 0.04881,
  secPerPatternMove: 0.02131,
  secPerSearchMove: 0.01314,
  secPerWallEdge: 0.00190,
  secPerZeroCluster: 0.00111,
  secPerMysteryCell: 0.00140,
  secPerLiarCell: 0.00123,
  secPerLockedCell: 0.03236,
  secPerWormholePair: 0.02555,
  secPerMirrorPair: 0.02862,
  secPerSonarCell: 0.05534,
  secPerCompassCell: 0.02655,
  secPerWormLoad: 0.00840,
};
// PAR_MODEL:END
...
export const PAR_MODEL_TIMED = {
  // Last refit: 2026-08-10 | brms-timed (n=143)
  // scale:"log" => par = exp(intercept + Σ coef·feature): multiplicative,
  // lognormal MEDIAN. Coefficients are LOG-MULTIPLIERS per unit, NOT seconds.
  ...
  intercept: 2.6800,
  secPerCell: 0.00144,
  secPerMineFlag: 0.04750,
  secPerPatternMove: 0.04960,
  secPerSearchMove: 0.01840,
  secPerWallEdge: 0.00242,
  secPerZeroCluster: 0.00152,
  secPerMysteryCell: 0.00181,
  secPerLiarCell: 0.00159,
  secPerLockedCell: 0.04225,
  secPerWormholePair: 0.03170,
  secPerMirrorPair: 0.03648,
  secPerSonarCell: 0.07211,
  secPerCompassCell: 0.03373,
  secPerWormLoad: 0.01060,
};
// TIMED_PAR_MODEL:END
