...
export const PAR_MODEL = {
  // Last refit: 2026-08-04 | brms (4 users · max Rhat = 1.003, min ESS = 1373, divergent = 0/4000) | N=389 scores, 162 dates, 5 players | R²=0.497 (log scale)
  ...
  intercept: 3.0132,
  secPerCell: 0.00057,
  secPerMineFlag: 0.04961,
  secPerPatternMove: 0.02070,
  secPerSearchMove: 0.01277,
  secPerWallEdge: 0.00173,
  secPerZeroCluster: 0.00104,
  secPerMysteryCell: 0.00136,
  secPerLiarCell: 0.00128,
  secPerLockedCell: 0.02447,
  secPerWormholePair: 0.00290,
  secPerMirrorPair: 0.02202,
  secPerSonarCell: 0.05206,
  secPerCompassCell: 0.02326,
  secPerWormLoad: 0.00648,
};
// PAR_MODEL:END
...
export const PAR_MODEL_TIMED = {
  // Last refit: 2026-08-04 | brms-timed (n=130)
  // scale:"log" => par = exp(intercept + Σ coef·feature): multiplicative,
  // lognormal MEDIAN. Coefficients are LOG-MULTIPLIERS per unit, NOT seconds.
  ...
  intercept: 2.6962,
  secPerCell: 0.00136,
  secPerMineFlag: 0.04710,
  secPerPatternMove: 0.04832,
  secPerSearchMove: 0.01869,
  secPerWallEdge: 0.00221,
  secPerZeroCluster: 0.00142,
  secPerMysteryCell: 0.00169,
  secPerLiarCell: 0.00162,
  secPerLockedCell: 0.03130,
  secPerWormholePair: 0.00378,
  secPerMirrorPair: 0.02808,
  secPerSonarCell: 0.06742,
  secPerCompassCell: 0.02947,
  secPerWormLoad: 0.00853,
};
// TIMED_PAR_MODEL:END
...
export const PAR_MODEL_SHAPES = {
  // Last refit: 2026-08-04 | composed: PAR_MODEL base + per-shape deviations
