...
export const PAR_MODEL = {
  // Last refit: 2026-08-18 | brms (5 users · max Rhat = 1.004, min ESS = 1218, divergent = 0/4000) | N=817 scores, 364 dates, 6 players | R²=0.537 (log scale)
  ...
  intercept: 0.2340,
  secPerCell: -0.00750,
  secPerLogCell: 0.76960,
  secPerMineFlag: 0.04751,
  secPerPatternMove: 0.03625,
  secPerSearchMove: 0.01399,
  secPerWallEdge: 0.00303,
  secPerZeroCluster: 0.00556,
  secPerMysteryCell: 0.00159,
  secPerLiarCell: 0.00141,
  secPerLockedCell: 0.04670,
  secPerWormholePair: 0.04029,
  secPerMirrorPair: 0.06123,
  secPerSonarCell: 0.07286,
  secPerCompassCell: 0.04998,
  secPerWormLoad: 0.01089,
};
// PAR_MODEL:END
...
export const PAR_MODEL_TIMED = {
  // Last refit: 2026-08-18 | brms-timed (n=146)
  // scale:"log" => par = exp(intercept + Σ coef·feature): multiplicative,
  // lognormal MEDIAN. Coefficients are LOG-MULTIPLIERS per unit, NOT seconds.
  ...
  secPerMineFlag: 0.04661,
  secPerPatternMove: 0.05250,
  secPerSearchMove: 0.02017,
  secPerWallEdge: 0.00387,
  secPerZeroCluster: 0.01172,
  secPerMysteryCell: 0.00203,
  secPerLiarCell: 0.00178,
  secPerLockedCell: 0.06158,
  secPerWormholePair: 0.05124,
  secPerMirrorPair: 0.07751,
  secPerSonarCell: 0.09243,
  secPerCompassCell: 0.06386,
  secPerWormLoad: 0.01406,
};
// TIMED_PAR_MODEL:END
...
export const PAR_MODEL_SHAPES = {
  // Last refit: 2026-08-18 | composed: PAR_MODEL base + per-shape deviations
  ...
  '4.8.8': {
    ...
    intercept: 0.1969,
    secPerCell: -0.00942,
    secPerLogCell: 0.98475,
    secPerMineFlag: 0.01629,
    secPerPatternMove: 0.03625,
    secPerSearchMove: 0.01399,
    secPerWallEdge: 0.00303,
    secPerZeroCluster: 0.05860,
    secPerMysteryCell: 0.00159,
    secPerLiarCell: 0.00141,
    secPerLockedCell: 0.04670,
    secPerWormholePair: 0.04029,
  ...
  hex: {
    ...
    intercept: -0.1633,
    secPerCell: -0.01767,
    secPerLogCell: 0.84640,
    secPerMineFlag: 0.07134,
    secPerPatternMove: 0.03625,
    secPerSearchMove: 0.01399,
    secPerWallEdge: 0.00303,
    secPerZeroCluster: 0.05468,
    secPerMysteryCell: 0.00159,
    secPerLiarCell: 0.00141,
    secPerLockedCell: 0.04670,
    secPerWormholePair: 0.04029,
    ...
    secPerSonarCell: 0.07286,
    secPerCompassCell: 0.04998,
    secPerWormLoad: 0.02278,
  },
  cairo: {
    scale: 'log',
    intercept: -0.1107,
    secPerCell: 0.01051,
    secPerLogCell: 0.79948,
    secPerMineFlag: 0.02103,
    secPerPatternMove: 0.03625,
    secPerSearchMove: 0.01399,
    secPerWallEdge: 0.00303,
    secPerZeroCluster: -0.05500,
    secPerMysteryCell: 0.00159,
    secPerLiarCell: 0.00141,
    secPerLockedCell: 0.04670,
    secPerWormholePair: 0.04029,
  ...
  floret: {
    ...
    intercept: 0.0284,
    secPerCell: -0.00917,
    secPerLogCell: 0.87180,
    secPerMineFlag: 0.06201,
    secPerPatternMove: 0.08272,
    secPerSearchMove: 0.01399,
    secPerWallEdge: 0.00303,
    secPerZeroCluster: 0.09015,
    secPerMysteryCell: 0.00159,
    secPerLiarCell: 0.00141,
    secPerLockedCell: 0.04670,
    secPerWormholePair: 0.04029,
  ...
  rhombille: {
    ...
    intercept: 0.4010,
    secPerCell: 0.01414,
    secPerLogCell: 0.85548,
    secPerMineFlag: -0.05850,
    secPerPatternMove: 0.03625,
    secPerSearchMove: 0.01399,
    secPerWallEdge: 0.00303,
    secPerZeroCluster: 0.24457,
    secPerMysteryCell: 0.00159,
    secPerLiarCell: 0.00141,
    secPerLockedCell: 0.04670,
    secPerWormholePair: 0.04029,
  ...
  deltoidal: {
    ...
    intercept: 0.5012,
    secPerCell: -0.00371,
    secPerLogCell: 0.75951,
    secPerMineFlag: 0.05264,
    secPerPatternMove: 0.14740,
    secPerSearchMove: 0.04369,
    secPerWallEdge: 0.00303,
    secPerZeroCluster: 0.09600,
    secPerMysteryCell: 0.00159,
    secPerLiarCell: 0.00141,
    secPerLockedCell: 0.04670,
    secPerWormholePair: 0.04029,
