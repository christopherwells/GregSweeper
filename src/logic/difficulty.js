...
export const PAR_MODEL = {
  // Last refit: 2026-05-16 | brms (2 users · max Rhat = 1.005, min ESS = 1474, divergent = 1/4000) | N=133 scores, 67 dates, 3 players | R²=0.619
  intercept: -16.17,
