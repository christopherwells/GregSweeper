...
export const PAR_MODEL = {
  // Last refit: 2026-08-01 | brms (4 users · max Rhat = 1.005, min ESS = 1187, divergent = 0/4000) | N=348 scores, 145 dates, 5 players | R²=0.496 (log scale)
  ...
  intercept: 2.9303,
  secPerCell: 0.00065,
  secPerMineFlag: 0.05374,
  secPerPatternMove: 0.01673,
  secPerSearchMove: 0.01272,
  secPerWallEdge: 0.00175,
  secPerZeroCluster: 0.00113,
  secPerMysteryCell: 0.00144,
  secPerLiarCell: 0.00135,
  secPerLockedCell: 0.03974,
  secPerWormholePair: 0.00157,
  secPerMirrorPair: 0.00844,
  secPerSonarCell: 0.04792,
  secPerCompassCell: 0.02258,
  secPerWormLoad: 0.00578,
};
// PAR_MODEL:END
...
export const PAR_MODEL_TIMED = {
  // Last refit: 2026-08-01 | brms-timed (n=123)
  // scale:"log" => par = exp(intercept + Σ coef·feature): multiplicative,
  // lognormal MEDIAN. Coefficients are LOG-MULTIPLIERS per unit, NOT seconds.
  ...
  intercept: 2.6690,
  secPerCell: 0.00134,
  secPerMineFlag: 0.04820,
  secPerPatternMove: 0.04990,
  secPerSearchMove: 0.01930,
  secPerWallEdge: 0.00226,
  secPerZeroCluster: 0.00159,
  secPerMysteryCell: 0.00189,
  secPerLiarCell: 0.00171,
  secPerLockedCell: 0.05023,
  secPerWormholePair: 0.00204,
  secPerMirrorPair: 0.01094,
  secPerSonarCell: 0.06249,
  secPerCompassCell: 0.02868,
  secPerWormLoad: 0.00733,
};
// TIMED_PAR_MODEL:END
