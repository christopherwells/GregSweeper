...
export const PAR_MODEL = {
  // Last refit: 2026-08-20 | brms (5 users · max Rhat = 1.004, min ESS = 1185, divergent = 0/4000) | N=835 scores, 370 dates, 6 players | R²=0.542 (log scale)
  ...
  intercept: 0.2159,
  secPerCell: -0.00741,
  secPerLogCell: 0.77530,
  secPerMineFlag: 0.04703,
  secPerPatternMove: 0.03662,
  secPerSearchMove: 0.01415,
  secPerWallEdge: 0.00290,
  secPerZeroCluster: 0.00456,
  secPerMysteryCell: 0.00174,
  secPerLiarCell: 0.00138,
  secPerLockedCell: 0.04689,
  secPerWormholePair: 0.04637,
  secPerMirrorPair: 0.06127,
  secPerSonarCell: 0.07176,
  secPerCompassCell: 0.05072,
  secPerWormLoad: 0.01115,
};
// PAR_MODEL:END
...
export const PAR_MODEL_TIMED = {
  ...
  secPerMineFlag: 0.04653,
  secPerPatternMove: 0.05203,
  secPerSearchMove: 0.02014,
  secPerWallEdge: 0.00359,
  secPerZeroCluster: 0.00837,
  secPerMysteryCell: 0.00222,
  secPerLiarCell: 0.00176,
  secPerLockedCell: 0.06119,
  secPerWormholePair: 0.05852,
  secPerMirrorPair: 0.07956,
  secPerSonarCell: 0.09324,
  secPerCompassCell: 0.06513,
  secPerWormLoad: 0.01425,
};
// TIMED_PAR_MODEL:END
...
export const PAR_MODEL_SHAPES = {
  ...
  '4.8.8': {
    ...
    intercept: 0.1850,
    secPerCell: -0.00935,
    secPerLogCell: 0.98856,
    secPerMineFlag: 0.01623,
    secPerPatternMove: 0.03662,
    secPerSearchMove: 0.01415,
    secPerWallEdge: 0.00290,
    secPerZeroCluster: 0.05825,
    secPerMysteryCell: 0.00174,
    secPerLiarCell: 0.00138,
    secPerLockedCell: 0.04689,
    secPerWormholePair: 0.04637,
  ...
  hex: {
    ...
    intercept: -0.1992,
    secPerCell: -0.01775,
    secPerLogCell: 0.85612,
    secPerMineFlag: 0.07159,
    secPerPatternMove: 0.03662,
    secPerSearchMove: 0.01415,
    secPerWallEdge: 0.00290,
    secPerZeroCluster: 0.05374,
    secPerMysteryCell: 0.00174,
    secPerLiarCell: 0.00138,
    secPerLockedCell: 0.04689,
    secPerWormholePair: 0.04637,
    ...
    secPerSonarCell: 0.07176,
    secPerCompassCell: 0.05072,
    secPerWormLoad: 0.02152,
  },
  cairo: {
    scale: 'log',
    intercept: -0.1179,
    secPerCell: 0.01042,
    secPerLogCell: 0.80472,
    secPerMineFlag: 0.02112,
    secPerPatternMove: 0.03662,
    secPerSearchMove: 0.01415,
    secPerWallEdge: 0.00290,
    secPerZeroCluster: -0.05601,
    secPerMysteryCell: 0.00174,
    secPerLiarCell: 0.00138,
    secPerLockedCell: 0.04689,
    secPerWormholePair: 0.04637,
  ...
  floret: {
    ...
    intercept: 0.0493,
    secPerCell: -0.00884,
    secPerLogCell: 0.86567,
    secPerMineFlag: 0.06162,
    secPerPatternMove: 0.08296,
    secPerSearchMove: 0.01415,
    secPerWallEdge: 0.00290,
    secPerZeroCluster: 0.08850,
    secPerMysteryCell: 0.00174,
    secPerLiarCell: 0.00138,
    secPerLockedCell: 0.04689,
    secPerWormholePair: 0.04637,
  ...
  rhombille: {
    ...
    intercept: 0.3488,
    secPerCell: 0.01433,
    secPerLogCell: 0.87292,
    secPerMineFlag: -0.06022,
    secPerPatternMove: 0.03662,
    secPerSearchMove: 0.01415,
    secPerWallEdge: 0.00290,
    secPerZeroCluster: 0.24584,
    secPerMysteryCell: 0.00174,
    secPerLiarCell: 0.00138,
    secPerLockedCell: 0.04689,
    secPerWormholePair: 0.04637,
  ...
  deltoidal: {
    ...
    intercept: 0.3389,
    secPerCell: 0.00437,
    secPerLogCell: 0.71225,
    secPerMineFlag: 0.04734,
    secPerPatternMove: 0.14175,
    secPerSearchMove: 0.05712,
    secPerWallEdge: 0.00290,
    secPerZeroCluster: -0.01725,
    secPerMysteryCell: 0.00174,
    secPerLiarCell: 0.00138,
    secPerLockedCell: 0.04689,
    secPerWormholePair: 0.04637,
