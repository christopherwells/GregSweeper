...
export const PAR_MODEL = {
  // Last refit: 2026-08-19 | brms (5 users · max Rhat = 1.004, min ESS = 1242, divergent = 0/4000) | N=826 scores, 367 dates, 6 players | R²=0.537 (log scale)
  ...
  intercept: 0.2409,
  secPerCell: -0.00747,
  secPerLogCell: 0.76869,
  secPerMineFlag: 0.04731,
  secPerPatternMove: 0.03657,
  secPerSearchMove: 0.01421,
  secPerWallEdge: 0.00293,
  secPerZeroCluster: 0.00534,
  secPerMysteryCell: 0.00160,
  secPerLiarCell: 0.00137,
  secPerLockedCell: 0.04578,
  secPerWormholePair: 0.04450,
  secPerMirrorPair: 0.06068,
  secPerSonarCell: 0.07203,
  secPerCompassCell: 0.04951,
  secPerWormLoad: 0.01072,
};
// PAR_MODEL:END
...
export const PAR_MODEL_TIMED = {
  // Last refit: 2026-08-19 | brms-timed (n=146)
  // scale:"log" => par = exp(intercept + Σ coef·feature): multiplicative,
  // lognormal MEDIAN. Coefficients are LOG-MULTIPLIERS per unit, NOT seconds.
  ...
  secPerMineFlag: 0.04688,
  secPerPatternMove: 0.05237,
  secPerSearchMove: 0.02003,
  secPerWallEdge: 0.00375,
  secPerZeroCluster: 0.01109,
  secPerMysteryCell: 0.00203,
  secPerLiarCell: 0.00176,
  secPerLockedCell: 0.05885,
  secPerWormholePair: 0.05707,
  secPerMirrorPair: 0.07677,
  secPerSonarCell: 0.09198,
  secPerCompassCell: 0.06307,
  secPerWormLoad: 0.01377,
};
// TIMED_PAR_MODEL:END
...
export const PAR_MODEL_SHAPES = {
  // Last refit: 2026-08-19 | composed: PAR_MODEL base + per-shape deviations
  ...
  '4.8.8': {
    ...
    intercept: 0.2094,
    secPerCell: -0.00955,
    secPerLogCell: 0.98448,
    secPerMineFlag: 0.01625,
    secPerPatternMove: 0.03657,
    secPerSearchMove: 0.01421,
    secPerWallEdge: 0.00293,
    secPerZeroCluster: 0.05940,
    secPerMysteryCell: 0.00160,
    secPerLiarCell: 0.00137,
    secPerLockedCell: 0.04578,
    secPerWormholePair: 0.04450,
  ...
  hex: {
    ...
    intercept: -0.1563,
    secPerCell: -0.01750,
    secPerLogCell: 0.84109,
    secPerMineFlag: 0.07131,
    secPerPatternMove: 0.03657,
    secPerSearchMove: 0.01421,
    secPerWallEdge: 0.00293,
    secPerZeroCluster: 0.05492,
    secPerMysteryCell: 0.00160,
    secPerLiarCell: 0.00137,
    secPerLockedCell: 0.04578,
    secPerWormholePair: 0.04450,
    ...
    secPerSonarCell: 0.07203,
    secPerCompassCell: 0.04951,
    secPerWormLoad: 0.02236,
  },
  cairo: {
    scale: 'log',
    intercept: -0.0804,
    secPerCell: 0.01091,
    secPerLogCell: 0.78972,
    secPerMineFlag: 0.02033,
    secPerPatternMove: 0.03657,
    secPerSearchMove: 0.01421,
    secPerWallEdge: 0.00293,
    secPerZeroCluster: -0.05618,
    secPerMysteryCell: 0.00160,
    secPerLiarCell: 0.00137,
    secPerLockedCell: 0.04578,
    secPerWormholePair: 0.04450,
  ...
  floret: {
    ...
    intercept: 0.0689,
    secPerCell: -0.00921,
    secPerLogCell: 0.86463,
    secPerMineFlag: 0.06226,
    secPerPatternMove: 0.08351,
    secPerSearchMove: 0.01421,
    secPerWallEdge: 0.00293,
    secPerZeroCluster: 0.08845,
    secPerMysteryCell: 0.00160,
    secPerLiarCell: 0.00137,
    secPerLockedCell: 0.04578,
    secPerWormholePair: 0.04450,
  ...
  rhombille: {
    ...
    intercept: 0.3971,
    secPerCell: 0.01443,
    secPerLogCell: 0.85738,
    secPerMineFlag: -0.06002,
    secPerPatternMove: 0.03657,
    secPerSearchMove: 0.01421,
    secPerWallEdge: 0.00293,
    secPerZeroCluster: 0.24644,
    secPerMysteryCell: 0.00160,
    secPerLiarCell: 0.00137,
    secPerLockedCell: 0.04578,
    secPerWormholePair: 0.04450,
  ...
  deltoidal: {
    ...
    intercept: 0.4981,
    secPerCell: -0.00269,
    secPerLogCell: 0.73245,
    secPerMineFlag: 0.05714,
    secPerPatternMove: 0.14805,
    secPerSearchMove: 0.05029,
    secPerWallEdge: 0.00293,
    secPerZeroCluster: 0.04106,
    secPerMysteryCell: 0.00160,
    secPerLiarCell: 0.00137,
    secPerLockedCell: 0.04578,
    secPerWormholePair: 0.04450,
