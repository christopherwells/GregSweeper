...
export const PAR_MODEL = {
  // Last refit: 2026-07-07 | brms (4 users · max Rhat = 1.004, min ESS = 986, divergent = 0/4000) | N=275 scores, 120 dates, 5 players | R²=0.488 (log scale)
  ...
  secPerCell:        0.00086,
  secPerMineFlag:    0.05642,

  // Reasoning tiers: pattern = canonical + generic subsets; search = advanced.
  secPerPatternMove: 0.01211,
  secPerSearchMove:  0.00659,

  // Board structure.
  secPerWallEdge:    0.00151,
  ...
  secPerLockedCell:    0.02851,
  secPerWormholePair:  0.00151,
  secPerMirrorPair:    0.02524,
  secPerSonarCell:     0.04584,
  secPerCompassCell:   0.03158,
...
export const PAR_MODEL_TIMED = {
  // Last refit: 2026-07-07 | brms-timed (n=63)
  ...
  intercept: 2.1682,
  secPerCell:        0.00133,
  secPerMineFlag:    0.07642,
  secPerPatternMove: 0.02264,
  secPerSearchMove:  0.01046,
  secPerWallEdge:    0.00191,
  secPerZeroCluster: 0.00146,
  secPerMysteryCell:   0.00171,
  secPerLiarCell:      0.00199,
  secPerLockedCell:    0.03609,
  secPerWormholePair:  0.00192,
  secPerMirrorPair:    0.03161,
  secPerSonarCell:     0.05884,
  secPerCompassCell:   0.03978,
};
// TIMED_PAR_MODEL:END
