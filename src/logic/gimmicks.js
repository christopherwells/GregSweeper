...
const GIMMICK_DEFS = {
  mystery:   { intro: 11, name: 'Mystery Cells',  icon: '❓', desc: 'Some numbered cells show "?" instead of their value.' },
  locked:    { intro: 16, name: 'Locked Cells',    icon: '🔒', desc: 'Locked cells can\'t be opened until all neighbors are revealed.' },
  liar:      { intro: 21, name: 'Liar Cells',      icon: '🤥', desc: 'A few cells display a number that\'s off by 1. They have a colored border so you know which ones lie.' },
  mineShift: { intro: 26, name: 'Mine Shift',      icon: '💨', desc: 'Every 30–45s, unflagged mines may shift to adjacent cells. Flagged mines stay put!' },
  walls:     { intro: 31, name: 'Walls',            icon: '🧱', desc: 'Impassable wall cells block the grid. They don\'t count as neighbors.' },
  wormhole:  { intro: 36, name: 'Wormholes',       icon: '🌀', desc: 'Paired cells share information — each shows the SUM of both cells\' real neighbor counts.' },
  mirror:    { intro: 41, name: 'Mirror Zone',      icon: '🪞', desc: 'A marked zone displays mirrored adjacency values — numbers swap with their opposite cell in the zone.' },
};
