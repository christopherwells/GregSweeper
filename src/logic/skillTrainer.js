...
const LESSONS = [
  ...
  },
  {
    ...
    puzzles: [
      ...
      buildPuzzle(3, 4, [[0,0]], allExcept(3,4,[[0,0],[0,3],[2,3]]), [[0,0]], [[0,3,'reveal'],[2,3,'reveal']], 'The flagged mine accounts for the 1. Hidden cells far from it must be safe.'),
  ...
  // ═════════════════════ INTERMEDIATE ═════════════════════
  {
    ...
    puzzles: [
      buildPuzzle(3, 4, [[0,0]], [[1,0],[1,1],[1,2],[1,3],[2,0],[2,1],[2,2],[2,3]], [], [[0,2,'reveal'],[0,3,'reveal']], 'The mine is next to one of the 1s. Cells past the pair can\'t be mines.'),
      buildPuzzle(3, 4, [[0,3]], [[1,0],[1,1],[1,2],[1,3],[2,0],[2,1],[2,2],[2,3]], [], [[0,0,'reveal'],[0,1,'reveal']], 'Same pattern, opposite direction. Cells past the pair are safe.'),
      buildPuzzle(4, 3, [[0,0]], [[0,1],[0,2],[1,1],[1,2],[2,1],[2,2],[3,0],[3,1],[3,2]], [], [[2,0,'reveal']], 'The 1-1 pattern works vertically too!'),
      buildPuzzle(3, 5, [[0,1]], [[1,0],[1,1],[1,2],[1,3],[1,4],[2,0],[2,1],[2,2],[2,3],[2,4]], [], [[0,3,'reveal'],[0,4,'reveal']], 'Find the 1-1 pair and reveal the cells beyond them.'),
      buildPuzzle(3, 5, [[0,0],[0,4]], [[1,0],[1,1],[1,2],[1,3],[1,4],[2,0],[2,1],[2,2],[2,3],[2,4]], [], [[0,2,'reveal']], 'Two 1-1 pairs from each end — the cell in the middle is safe.'),
    ],
  },
  {
    id: 'pattern-1-2',
    ...
    puzzles: [
      buildPuzzle(3, 4, [[0,0],[0,2]], [[1,0],[1,1],[1,2],[1,3],[2,0],[2,1],[2,2],[2,3]], [], [[0,2,'flag']], 'The 2 needs one more mine than the 1. That extra mine is on the 2\'s outer side.'),
      buildPuzzle(3, 4, [[0,1],[0,3]], [[1,0],[1,1],[1,2],[1,3],[2,0],[2,1],[2,2],[2,3]], [], [[0,0,'reveal']], 'The 1 on the edge tells you the corner cell is safe to reveal.'),
      buildPuzzle(3, 5, [[0,0],[0,2]], [[1,0],[1,1],[1,2],[1,3],[1,4],[2,0],[2,1],[2,2],[2,3],[2,4]], [], [[0,3,'reveal'],[0,4,'reveal']], 'The mines are near the 1-2 pair. Cells beyond are safe.'),
      buildPuzzle(3, 5, [[0,0],[0,1]], [[1,0],[1,1],[1,2],[1,3],[1,4],[2,0],[2,1],[2,2],[2,3],[2,4]], [], [[0,3,'reveal'],[0,4,'reveal']], 'The 1-2 constraint pins the mines to one side. Far cells are safe.'),
      buildPuzzle(4, 4, [[0,0],[0,1]], [[1,0],[1,1],[1,2],[1,3],[2,0],[2,1],[2,2],[2,3],[3,0],[3,1],[3,2],[3,3],[0,2],[0,3]], [], [[0,0,'flag'],[0,1,'flag']], 'The 2 in the corner needs 2 mines among its hidden neighbors. Flag them both!'),
    ],
  },
  {
    id: 'wall-logic',
    ...
    puzzles: [
      buildPuzzle(4, 4, [[0,0]], [[0,1],[1,0],[1,1],[0,2],[0,3],[1,2],[1,3],[2,0],[2,1],[2,2],[2,3],[3,0],[3,1],[3,2],[3,3]], [], [[0,0,'flag']], 'The 1 in the corner only has one hidden neighbor — it must be the mine.'),
      buildPuzzle(5, 4, [[0,1]], [[0,0],[0,2],[0,3],[1,0],[1,1],[1,2],[1,3],[2,0],[2,1],[2,2],[2,3]], [], [[0,1,'flag']], 'The 1 on the top edge touches only one hidden cell.'),
      buildPuzzle(4, 5, [[3,2]], [[0,0],[0,1],[0,2],[0,3],[0,4],[1,0],[1,1],[1,2],[1,3],[1,4],[2,0],[2,1],[2,2],[2,3],[2,4],[3,0],[3,1],[3,3],[3,4]], [], [[3,2,'flag']], 'The 1 on the bottom edge has only one hidden neighbor — flag it!'),
      buildPuzzle(5, 4, [[2,0]], [[0,0],[0,1],[0,2],[0,3],[1,0],[1,1],[1,2],[1,3],[2,1],[2,2],[2,3],[3,0],[3,1],[3,2],[3,3],[4,0],[4,1],[4,2],[4,3]], [], [[2,0,'flag']], 'The left wall limits this number\'s neighbors. Only one cell is hidden.'),
      buildPuzzle(4, 4, [[0,0],[1,1]], [[0,1],[0,2],[0,3],[1,0],[1,2],[1,3],[2,0],[2,1],[2,2],[2,3],[3,0],[3,1],[3,2],[3,3]], [], [[0,0,'flag'],[1,1,'flag']], 'The 2 in the corner has exactly 2 hidden neighbors. Both are mines!'),
    ],
  },
  {
    id: 'corner-deduction',
    ...
    puzzles: [
      buildPuzzle(4, 4, [[1,0]], [[0,0],[0,1],[0,2],[0,3],[1,1],[1,2],[1,3],[2,0],[2,1],[2,2],[2,3],[3,0],[3,1],[3,2],[3,3]], [], [[1,0,'flag']], 'The 1 in the top-left corner has only one hidden neighbor. Flag it!'),
      buildPuzzle(4, 4, [[0,1],[1,0]], [[0,0],[1,1],[0,2],[0,3],[1,2],[1,3],[2,0],[2,1],[2,2],[2,3],[3,0],[3,1],[3,2],[3,3]], [], [[0,1,'flag'],[1,0,'flag']], 'The 2 in the corner has 3 neighbors, and 2 are hidden — both must be mines!'),
      ...
      buildPuzzle(5, 5, [[0,1],[1,4]], [[0,0],[0,2],[0,3],[0,4],[1,0],[1,1],[1,2],[1,3],[2,0],[2,1],[2,2],[2,3],[2,4],[3,0],[3,1],[3,2],[3,3],[3,4],[4,0],[4,1],[4,2],[4,3],[4,4]], [], [[0,1,'flag'],[1,4,'flag']], 'Combine corner and edge clues to find both mines.'),
    ],
  },
  {
    id: 'reduction',
  ...
  // ═════════════════════ ADVANCED ═════════════════════
  {
    ...
    puzzles: [
      ...
      buildPuzzle(4, 5, [[0,0],[0,3]], [[1,0],[1,1],[1,2],[1,3],[1,4],[2,0],[2,1],[2,2],[2,3],[2,4],[3,0],[3,1],[3,2],[3,3],[3,4]], [], [[0,4,'reveal']], 'The far-right cell isn\'t covered by the smaller constraint — it\'s safe.'),
      buildPuzzle(3, 6, [[0,0],[0,4]], [[1,0],[1,1],[1,2],[1,3],[1,4],[1,5],[2,0],[2,1],[2,2],[2,3],[2,4],[2,5]], [], [[0,5,'reveal']], 'Cells outside the overlapping constraint zone are guaranteed safe.'),
      buildPuzzle(4, 5, [[0,0],[0,1],[0,4]], [[1,0],[1,1],[1,2],[1,3],[1,4],[2,0],[2,1],[2,2],[2,3],[2,4],[3,0],[3,1],[3,2],[3,3],[3,4]], [], [[0,4,'flag']], 'Subtracting the subset from the superset reveals: the leftover cell is a mine!'),
    ],
  },
  {
    ...
    puzzles: [
      buildPuzzle(4, 5, [[0,0],[0,4]], [[1,0],[1,1],[1,2],[1,3],[1,4],[2,0],[2,1],[2,2],[2,3],[2,4],[3,0],[3,1],[3,2],[3,3],[3,4]], [], [[0,2,'reveal']], 'No single number solves this. Combine what both 1s tell you about the middle cell.'),
      buildPuzzle(3, 5, [[0,0],[0,2]], [[1,0],[1,1],[1,2],[1,3],[1,4],[2,0],[2,1],[2,2],[2,3],[2,4]], [], [[0,4,'reveal']], 'Chain deductions along the wall to find the safe cell at the end.'),
      ...
      buildPuzzle(4, 5, [[0,1],[0,3]], [[1,0],[1,1],[1,2],[1,3],[1,4],[2,0],[2,1],[2,2],[2,3],[2,4],[3,0],[3,1],[3,2],[3,3],[3,4]], [], [[0,0,'reveal'],[0,4,'reveal']], 'The coupled 1s along the wall pin the mines inward — the ends are safe!'),
      buildPuzzle(5, 5, [[0,0],[0,4],[4,2]], allExcept(5,5,[[0,0],[0,4],[4,2]]), [], [[0,0,'flag'],[0,4,'flag'],[4,2,'flag']], 'Use multiple number groups together to locate all three mines.'),
    ],
  },
  {
    id: 'probability',
    ...
    puzzles: [
      ...
      buildPuzzle(3, 4, [[0,0]], [[1,0],[1,1],[1,2],[1,3],[2,0],[2,1],[2,2],[2,3]], [], [[0,2,'reveal'],[0,3,'reveal']], 'One mine among many hidden cells. The further from the 1, the safer.'),
      ...
      buildPuzzle(4, 5, [[0,0]], [[1,0],[1,1],[1,2],[1,3],[1,4],[2,0],[2,1],[2,2],[2,3],[2,4],[3,0],[3,1],[3,2],[3,3],[3,4]], [], [[0,3,'reveal'],[0,4,'reveal']], 'Cells far from the constraint are least likely to be mines.'),
      buildPuzzle(5, 5, [[2,2]], [[1,1],[1,2],[1,3],[2,1],[2,3],[3,1],[3,2],[3,3],[0,0],[0,4],[4,0],[4,4]], [], [[0,1,'reveal'],[0,2,'reveal'],[0,3,'reveal']], 'The mine is surrounded by numbers in the center. Far-away cells are safe.'),
    ],
  },
  {
    id: 'endgame',
    ...
    puzzles: [
      ...
      buildPuzzle(4, 4, [[0,0]], allExcept(4,4,[[0,0],[3,2],[3,3]]), [[0,0]], [[3,2,'reveal'],[3,3,'reveal']], 'All mines are flagged (mine counter shows 0). Every remaining cell is safe!'),
      ...
      buildPuzzle(5, 5, [[4,0],[4,4]], allExcept(5,5,[[4,0],[4,1],[4,3],[4,4]]), [], [[4,1,'reveal'],[4,3,'reveal']], 'Two mines in four cells. The numbers tell you which two are safe.'),
    ],
  },
  {
    id: 'speed-techniques',
    ...
    puzzles: [
      ...
      buildPuzzle(4, 5, [[0,0],[0,4]], [[0,1],[0,2],[0,3],[1,0],[1,1],[1,2],[1,3],[1,4],[2,0],[2,1],[2,2],[2,3],[2,4],[3,0],[3,1],[3,2],[3,3],[3,4]], [], [[0,0,'flag'],[0,4,'flag']], 'Two corner mines — recognize and flag both instantly!'),
      buildPuzzle(5, 5, [[0,0]], allExcept(5,5,[[0,0],[4,3],[4,4]]), [], [[0,0,'flag']], 'Flag the obvious mine first, then chord nearby numbers to clear fast.'),
      buildPuzzle(5, 5, [[0,2],[4,2]], [[0,0],[0,1],[0,3],[0,4],[1,0],[1,1],[1,2],[1,3],[1,4],[2,0],[2,1],[2,2],[2,3],[2,4],[3,0],[3,1],[3,2],[3,3],[3,4],[4,0],[4,1],[4,3],[4,4]], [], [[0,2,'flag'],[4,2,'flag']], 'Start at the edges where constraints are strongest. Flag both edge mines!'),
      buildPuzzle(4, 4, [[0,0],[3,3]], [[0,1],[0,2],[0,3],[1,0],[1,1],[1,2],[1,3],[2,0],[2,1],[2,2],[2,3],[3,0],[3,1],[3,2]], [], [[0,0,'flag'],[3,3,'flag']], 'Two corner 1s — instant pattern recognition. Flag both without thinking!'),
    ],
  },
];
