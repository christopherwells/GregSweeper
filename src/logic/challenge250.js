...
export const ENDLESS_SPECS = Object.freeze([
  E(3.61, T('4.8.8', 7, 8, 98, 30, ['wormhole', 'compass', 'locked'], { gimmickLevel: 120 })),
  E(3.66, T('hex', 9, 8, 72, 31)),
  E(3.71, T('hex', 9, 8, 72, 31, ['walls'], { gimmickLevel: 120 })),
  E(3.73, R(11, 14, 57, ['liar'], { gimmickLevel: 100 })),
  E(3.73, R(11, 14, 57, ['walls', 'liar'], { gimmickLevel: 100 })),
  E(3.74, T('deltoidal', 2, 3, 36, 10, ['sonar', 'walls'], { gimmickLevel: 120 })),
  E(3.76, T('rhombille', 4, 5, 60, 24, ['locked'], { gimmickLevel: 100 })),
  E(3.83, T('4.8.8', 6, 7, 72, 27, ['compass', 'locked'], { gimmickLevel: 120 })),
  E(3.84, T('hex', 9, 8, 72, 31, ['worm', 'walls'], { gimmickLevel: 120 })),
  ...
  E(3.98, T('floret', 3, 4, 72, 22, ['sonar', 'liar'], { gimmickLevel: 120 })),
  E(3.99, T('deltoidal', 2, 3, 36, 12, ['sonar', 'walls'], { gimmickLevel: 100 })),
  E(4.00, R(11, 11, 52, ['locked', 'liar'], { gimmickLevel: 120 })),
  E(4.02, T('hex', 11, 10, 110, 37, ['worm', 'walls'], { gimmickLevel: 120 })),
  ...
  E(4.15, T('hex', 9, 8, 72, 31, ['compass', 'walls'], { gimmickLevel: 100 })),
  E(4.19, T('floret', 3, 3, 54, 22, ['walls'], { gimmickLevel: 100 })),
  ...
  E(4.40, R(12, 12, 58, ['locked', 'liar'], { gimmickLevel: 100 })),
  E(4.44, T('4.8.8', 7, 8, 98, 33, ['wormhole', 'locked'], { gimmickLevel: 120 })),
  E(4.45, T('hex', 11, 10, 110, 37, ['worm', 'compass', 'walls'], { gimmickLevel: 100 })),
  E(4.47, T('deltoidal', 2, 4, 48, 15, ['mystery', 'locked'], { gimmickLevel: 100 })),
  E(4.51, T('cairo', 9, 9, 144, 48, ['locked'], { gimmickLevel: 100 })),
  E(4.56, T('cairo', 9, 9, 144, 43, ['locked'], { gimmickLevel: 100 })),
  E(4.60, T('floret', 3, 3, 54, 22, ['sonar', 'liar', 'walls'], { gimmickLevel: 100 })),
  E(4.66, T('4.8.8', 6, 7, 72, 29, ['wormhole', 'compass', 'locked'], { gimmickLevel: 120 })),
  E(4.67, T('deltoidal', 3, 3, 54, 17)),
  ...
  E(5.39, T('4.8.8', 6, 7, 72, 31, ['compass', 'locked'], { gimmickLevel: 100 })),
  E(5.43, T('deltoidal', 2, 3, 36, 12, ['locked', 'sonar', 'walls'], { gimmickLevel: 120 })),
  E(5.47, T('floret', 3, 4, 72, 27, ['liar', 'walls'], { gimmickLevel: 120 })),
  E(5.54, T('deltoidal', 2, 3, 36, 14, ['locked', 'sonar', 'walls'], { gimmickLevel: 100 })),
  E(5.57, T('4.8.8', 7, 8, 98, 36, ['locked'], { gimmickLevel: 100 })),
  E(5.86, T('floret', 3, 3, 54, 23, ['sonar', 'liar'], { gimmickLevel: 120 })),
  E(6.20, T('deltoidal', 2, 3, 36, 13, ['locked', 'sonar', 'walls'], { gimmickLevel: 120 })),
  E(6.56, T('floret', 3, 4, 72, 29, ['liar', 'walls'], { gimmickLevel: 100 })),
  E(7.07, T('deltoidal', 3, 3, 54, 17, ['locked', 'sonar', 'walls'], { gimmickLevel: 120 })),
  E(7.16, T('floret', 3, 4, 72, 29, ['sonar', 'liar'], { gimmickLevel: 100 })),
  E(7.74, T('floret', 3, 4, 72, 31)),
  E(8.26, T('floret', 3, 4, 72, 31, ['liar', 'walls'], { gimmickLevel: 100 })),
]);
