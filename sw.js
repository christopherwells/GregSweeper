const CACHE_NAME = 'gregsweeper-v1.11.16';
const ASSETS = [
  './',
  './index.html',
  './src/main.js',
  ...
  './src/audio/sounds.js',
  './src/logic/adjacency.js',
  './src/logic/boardPack.js',
  ...
  //   './src/ui/journalView.js',
  //   './src/ui/journalFigure.js',
  //   './src/ui/journalReport.js',
  //   './src/ui/journalCard.js',
  //   './src/logic/journalFindings.js',
  //   './src/logic/journalProse.js',
  //   './src/logic/proseRails.js',
  //   './src/logic/journalRewrite.js',
  //   './src/ui/journalHeatmap.js',
  //   './src/logic/boardHeatmap.js',
  ...
  './src/logic/tilingBandConfigs.js',
